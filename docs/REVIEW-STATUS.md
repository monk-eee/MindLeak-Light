...
The six later review findings have the following release status. Cancellation and
final snapshots shipped in v0.3.0; the other four are included in v0.4.0.
