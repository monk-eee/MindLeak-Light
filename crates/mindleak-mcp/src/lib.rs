...
impl ServerHandler for MemoryMcp {
    fn get_info(&self) -> ServerConfig {
        ...
        config.instructions = Some(concat!(
            ...
            "Understand the hierarchy before starting: observations preserve sources, chains explain evidence and conditions, and principles provide reusable procedures. ",
            "Before substantial work, consider relevant prior experience. Memory use is optional; when useful, use recall_memory with focused terms and limit 5; ",
            ...
            "Use the best applicable lesson first; inspect supporting sources as needed, not all history. ",
            "After a verified result, failure, exception or decision, make a memory checkpoint: ",
            "check equivalent evidence, then save what is new, link a correction or retain no new memory. ",
            "Save verified reusable evidence with conditions, outcome, next action, source and the check actually run. ",
            "After applying a lesson, retain new evidence or exceptions and the IDs/revisions used. ",
            ...
            "At task start in explicitly chosen knowledge workflows, consider applicable principles; when helpful, read their procedure, revision and requiresReview state before implementation. ",
            "Inspect supporting chains for reasoning and conditions, then original observations as needed; verify the current codebase rather than copying a previous answer. ",
            "Form knowledge from inspected sources, validate before accepting and preserve counterevidence. ",
